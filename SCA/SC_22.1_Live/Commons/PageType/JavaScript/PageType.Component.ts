...
import { PageTypeSettingsModel } from './PageType.Settings.Model';
...
export = function PageTypeComponentGenerator(application) {
    ...
    var PageTypeComponent = SCBaseComponent.extend({
                ...
                if (pagetype.view) {
                    ...
                    if (page) {
                        ...
                        if (
                            ...
                            const model = new PageTypeSettingsModel({
                                internalId: page.get('customrecorddata'),
                                recName: page.get('customrecordscriptid')
                            });
                            model.fetch().done(fields => {
                                options.pageInfo.fields = fields;
        ...
        _CmsViewPromisesDone: function(doneData: { view: any; pageType: any; loggers: Loggers }) {
            const data = {
                view: doneData.view,
            ...
            PageTypeComponent._CmsViewPromises(data).done(function() {
                ...
                const showContentPromise = doneData.view.showContent();
                showContentPromise &&
